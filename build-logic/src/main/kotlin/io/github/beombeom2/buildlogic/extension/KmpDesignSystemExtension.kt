...
abstract class KmpDesignSystemExtension @Inject constructor(objects: ObjectFactory) {
    val enableAndroid: Property<Boolean> =
        objects.property(Boolean::class.java).convention(true)

    val enableIos: Property<Boolean> =
        objects.property(Boolean::class.java).convention(true)

    val enableDesktop: Property<Boolean> =
        objects.property(Boolean::class.java).convention(true)
    ...
    val enableHostTests: Property<Boolean> =
        objects.property(Boolean::class.java).convention(false)

    val enableDeviceTests: Property<Boolean> =
        objects.property(Boolean::class.java).convention(false)

    val enableAndroidDeviceTestDeps: Property<Boolean> =
        objects.property(Boolean::class.java).convention(false)

    val useKoin: Property<Boolean> =
        objects.property(Boolean::class.java).convention(false)
}
